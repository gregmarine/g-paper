...
Publishing is **mavenLocal-only** for 0.1.9. From a g-paper checkout:
...
```
com.symmetricalpalmtree.gpaper:gpaper-core:0.1.9
com.symmetricalpalmtree.gpaper:gpaper-onyx:0.1.9
com.symmetricalpalmtree.gpaper:gpaper-ratta:0.1.9
```
...
```kotlin
dependencies {
    implementation("com.symmetricalpalmtree.gpaper:gpaper-ratta:0.1.9")
}
```
